...
![github](/images/githubsetting.png)
...
到这一步，应该说所需要的环境已经基本搭建完成，我们在github respository管理页面右侧点击settings，如下：
![github](/images/pagesetting.png)

然后在Github Pages那一栏里点击Automatic Page Generator按钮即可自动生成一个github pages的模板供我们使用。
![github](/images/pagegenerator.png)
